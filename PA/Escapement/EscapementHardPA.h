...
*/
/* File EscapementHardPA.h: Defines the user interface with EscapementHardPA.c for TI MSP430
...
/* Escapement can work under 3 possible scheduling algorithms. Under EDF, tasks are sche-
...
** adjust the core frequency. We however recommend that this task be left to Escapement.
** Parameter: (UINT8) A valid speed setting defined by a OS_xxMHZ_SPEED value. */
...
** responding SC functions call to provide synchronization support for Escapement. The LL/SC
