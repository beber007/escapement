...
**          functions needed by the Escapement family of kernels so that these can easily be
**          ported from one MSP to another and also to other microcontrollers.
** Version identifier: June 2011
*/
#include "Escapement.h"  /* Needed for the definitions of OSUINT16_LL and OSUINT16_SC */
...
** This is done by simply simulating an input signal edge occurring for the pin inter-
** rupt by setting its flag. The interrupt takes effect immediately if the port inter-
** rupts are enabled. */
