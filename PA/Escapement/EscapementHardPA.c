...
*/
/* File EscapementHardPA.c: Hard real-time kernel implementation with power-aware schemes
...
#if ESCAPEMENT_VERSION == ESCAPEMENT_VERSION_HARD_PA
...
#define STATE_RUNNING       0x01 /* These values are also used in Escapement_msp430XXX.asm */
#define STATE_ZOMBIE        0x02 /* or in Escapement_cc430XXX.asm */
...
** a fundamental atomic instruction building block used within Escapement, they are emulated
...
** left unchanged.
** All but 16-bit pointer LL/SC manipulations are given in Escapement.h. In fact, 16-bit
...
UINT16 _OSIdleSP; // Claude permet de détecter si la prochaine tâche à executer est la tâche NULL
...
UINT8 GetTaskPriority(INT32 deadline)
{
  ...
  ** starting Escapement. Note that after creating the last task, _OSQueueTail->Priority
...
** Escapement_msp430xxx.asm or Escapement_cc430xxx.asm */
