...
;
; File Escapement_msp430f5419A_36A_38A.asm: Holds msp430f5419A_36A_38A dependent assembler
;                                        implemented for EscapementHard functions.
; Created on June 22, 2011, by Escapement MSP430 Configurator Tool.

; Include device definitions and Escapement configuration files
  .cdecls C,LIST,"msp430.h"
  .cdecls C,LIST,"Escapement_msp430f5419A_36A_38A.h"
  .cdecls C,LIST,"Escapement.h"


; ******************************************
; Global Variables Shared with EscapementHard.c
; ******************************************
...
; *************************************
; Imported Functions From EscapementHard.c
; *************************************
...
; Timer0 A (int53): Interval timer0 A interrupt handler used by Escapement to propagate
...
Port2_0:
  ...
  mov #OS_IO_PORT2_0,r13            ; Load interrupt entry to Escapement device handler table in R13
  SaveCtx                           ; Save context of the application task
...
OSMalloc_InfiniteLoop:
     jmp OSMalloc_InfiniteLoop      ; Memory overflow: increase the value of OSMALLOC_IN-
                                    ; TERNAL_HEAP_SIZE defined in Escapement_msp430f5419A_36A_38A.h
  .else
...
; **********************************
; Internal Functions Used By Escapement
; **********************************

; _OSEnableSoftTimerInterrupt: Enables I/O Port 2 pin 7 interrupts. This function is
; used by Escapement after it finishes handling a timer interrupt.
  .text
