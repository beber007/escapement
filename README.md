...
| | |
|---|---|
| **5,248 bytes** | the whole kernel and four periodic tasks, on a Cortex-M0+ built at `-O2` |
| **7.0 µs** | cost of one scheduling round, measured on the board — 0.7 % of the processor at a thousand activations per second |
