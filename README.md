...
| | |
|---|---|
| **6,804 bytes** | the whole kernel and four periodic tasks, on a Cortex-M0+ |
| **7.0 µs** | cost of one scheduling round, measured on the board — 0.93 % of the processor at 1,330 activations per second |
