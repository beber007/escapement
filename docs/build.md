...
|---|---|---|---|---|
| `stm32f4-discovery` | Cortex-M4 | STM32F407VG | 3 | 3,840 / 477 / 36 |
| `stm32l-discovery` | Cortex-M3 | STM32L152RB | 4 | 3,932 / 5 / 216 |
| `stm32l-discovery-pa` | Cortex-M3 | STM32L152RB | 1 (*power-aware*) | 4,498 / 7 / 224 |
