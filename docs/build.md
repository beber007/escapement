...
|---|---|---|---|---|
| `stm32f4-discovery` | Cortex-M4 | STM32F407VG | 3 | 4,036 / 477 / 36 |
| `stm32l-discovery` | Cortex-M3 | STM32L152RB | 4 | 4,148 / 5 / 216 |
| `stm32l-discovery-pa` | Cortex-M3 | STM32L152RB | 1 (*power-aware*) | 4,702 / 7 / 224 |
