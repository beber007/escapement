...
** RP2040 fixed: 3 s. */
#define TICKS_WATCHDOG_CTRL   *((volatile UINT32 *)(0x40108000 + 0x30))
#define TICKS_WATCHDOG_CYCLES *((volatile UINT32 *)(0x40108000 + 0x34))
#define WATCHDOG_TICKS    3000000u
/* Priority of alarm 3, in the 4 most significant bits of its byte: that of the timer
...
** power-aware kernel is not ported to the RP2350. */
...
int main(void)
{
  ...
  ** takes it over: core 1 runs, and nothing pauses it any more. */
  ...
  TICKS_WATCHDOG_CYCLES = 12;           // the 12 MHz crystal
