...
**   (1) Run Escapement Configurator Tool for your MSP430 (must have an ADC12) and
...
/* UART entries to the interrupt table generated by Escapement Configurator Tool are renamed
