...
*/
/* File Escapement_UART.c: Contains the implementation of an API allowing facilitated message
...
#ifndef _ESCAPEMENT_UART_H_
#define _ESCAPEMENT_UART_H_
