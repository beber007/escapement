...
**          functions needed by Escapement so that these can easily be ported from one MSP to
...
void _OSStartTimer(void)
{
  ...
  #if !defined(ESCAPEMENT_VERSION_HARD_PA) && !defined(ESCAPEMENT_VERSION_SOFT_PA)
