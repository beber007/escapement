...
*/
/* File Escapement_Atomic.h: Defines the LL/SC atomic instructions used with the types de-
**                        fined for Escapement kernels.
...
** context switch. This action is done in Escapement_msp430XXX.asm or Escapement_cc430XXX.asm.
**/
