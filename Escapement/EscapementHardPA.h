...
*/
/* File EscapementHardPA.h: Defines the user interface with EscapementHardPA.c.
...
/* Escapement can operate under 3 possible scheduling algorithms. Under EDF, tasks are sche-
...
** frequency. We however recommend that this task be left to Escapement.
** Parameter: (UINT8) A valid speed setting defined by a OS_xxMHZ_SPEED value. */
