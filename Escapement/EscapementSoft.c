...
*/
/* File EscapementSoft.c: Generic kernel implementation of soft real-time with (m,k)-firm
**                     guarantees.
...
UINT8 GetTaskPriority(INT32 deadline)
{
  ...
  ** Escapement, and it is only at that time that the initial arrival time if the task is
